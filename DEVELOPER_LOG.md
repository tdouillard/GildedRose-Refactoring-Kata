...
| 2025-11-05 | Update, test jest snapshot and comparing with texttests stderr + Apply fix related to wrong assertions and item handling | As mention before, i used new class by expecting to change "items" values but due to restrictions i used reference of Item in this new Class in order to apply change without having to reinstanciate everytime. It still create a duplicate array in GildedRose class but it avoids reinstanciation of all new elements on every loop tick | 30m |
